    ...
    <div className="relative min-h-screen flex flex-col">
      ...
      <div className="relative z-10 flex-1 flex items-center justify-center text-center px-6">
        <div className="max-w-3xl">
          ...
          <button
            className="cursor-pointer px-8 py-3 bg-blue-700 hover:bg-blue-800 text-white font-bold text-lg rounded-lg shadow-lg hover:scale-105 transition-all duration-200"
            onClick={() => navigate("/")}
          >
            Get Started ➤
          </button>
